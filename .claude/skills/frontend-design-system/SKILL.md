...
1. @.claude/skills/brand-foundation/references/brand-summary.md — brand direction and visual priorities
2. @.claude/skills/frontend-design-system/references/design-system-implementation.md — distilled implementation workflow
