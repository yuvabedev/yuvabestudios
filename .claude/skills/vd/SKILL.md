...
1. @.claude/skills/brand-foundation/references/brand-summary.md — shared brand system (always first)
...
- If a neutral needs a brand tint, add a named tinted-neutral token to the design system first — never mix colors ad hoc.
...
When implementation is needed, hand off to `/frontend-design-system` rather than putting code-specific rules here.
