...
export const jobListings: Job[] = [
  ...
  },
  {
    ...
    posted: "2026-05-05",
    summary:
      "As the Sales Head at Yuvabe Studios, you will spearhead our sales and business development initiatives, drive revenue growth, and expand our client base. Your strategic vision and leadership will be pivotal in positioning Yuvabe as a leader in creative and sustainable solutions.",
    responsibilities: [
      "Develop and implement comprehensive sales strategies (Inside, Outside and Enterprise Sales) to achieve organisational objectives and revenue targets.",
      "Lead, mentor, and develop a high-performing sales team, ensuring clear goal setting, performance tracking, and continuous professional growth.",
      "Conduct thorough market research and competitive analysis to identify new business opportunities, trends, and potential clients.",
      "Build and maintain strong relationships with key clients, partners, and stakeholders to drive business growth and brand reputation.",
      "Drive the end-to-end sales process, from prospecting and lead generation to negotiation and closing deals.",
      "Establish, track, and analyse sales KPIs to assess team performance and implement data-driven improvements.",
      "Work closely with marketing, product, and operations teams to align sales strategies with business goals and customer needs.",
      "Identify new revenue streams, partnerships, and expansion opportunities for sustainable business growth.",
      "Travel as needed to meet clients, attend industry events, conferences, and networking opportunities to expand Yuvabe's market presence.",
    ],
    requirements: [
      "Bachelor's degree in Business Administration, Marketing, Sales, or a related field. A Master's degree (MBA) is preferred.",
      "Minimum 7+ years of proven experience in sales leadership roles, preferably within the creative, technology, or digital marketing sectors.",
      "Strong track record of achieving sales targets and managing high-value client accounts.",
      "Ability to lead, inspire, and manage a sales team effectively.",
      "Excellent interpersonal, communication, and negotiation skills to engage with stakeholders at all levels.",
      "Deep understanding of industry trends, market dynamics, and customer behavior.",
      "Proficiency in data analysis, CRM tools, and sales forecasting to drive informed decision-making.",
      "Strong organisational skills with the ability to manage multiple priorities and deadlines.",
      "Familiarity with CRM and sales tools such as Zoho and Apollo is preferred.",
    ],
    niceToHave: [],
    benefits: {
      remote: [
    ...
    compensation: "Competitive Salary with Variable Pay",
  },
  {
